...
# На вход программе подается количество пар синонимов nn. Далее следует nn строк, каждая строка содержит два слова-синонима.
...
unic_ids = list()
for i in data:
    if i['shiftId'] in unic_ids:
        print(i['shiftId'])
    else:
        unic_ids.append(i['shiftId'])

print(len(unic_ids), 'done', sep='\n')